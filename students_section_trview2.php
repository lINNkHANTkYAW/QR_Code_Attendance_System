...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto"> 
            ...
            <li class="nav-item">
                <a class="nav-link" href="sections.php?section=<?= htmlspecialchars($section) ?>"> Sections</a>
            </li>
            <li class="nav-item ">
...
<div class="container">
    ...
    <div class="back-button mt-4">
        <a href="majorsForTr.php?section=<?= htmlspecialchars($section) ?>" class="btn btn-primary">Back to Majors</a>
    </div>
</div>
