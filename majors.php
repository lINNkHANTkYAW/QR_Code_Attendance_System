    ...
    <div class="container">
        ...
        <div class="majors">
            <?php foreach ($majors as $major): ?>
                <a href="attendanceTrView.php?section=<?php echo htmlspecialchars($section); ?>&major=<?php echo urlencode($major); ?>" class="major-btn"><?php echo htmlspecialchars($major); ?></a>
            <?php endforeach; ?>
        </div>
        <!-- Back Button -->
        <div class="back-button mt-4">
            <a href="sections2.php" class="btn btn-primary">Back to Sections</a>
        </div>
        <div class="students-section">
            <a href="students_section_trview.php?section=<?php echo htmlspecialchars($section); ?>" class="students-btn">View Student List</a>
        </div>
    </div>
